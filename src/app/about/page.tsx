import { Calendar, Github, Linkedin, MapPin, SquareAsterisk, Youtube } from "lucide-react";
                ...
                <div className="flex flex-wrap gap-4 justify-center md:justify-start text-sm text-gray-500">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <Link
                      ...
                      target="_blank"
                    >
                      github.com/surfer-kim
                    </Link>
                  </div>
                  <div className="flex items-center gap-1">
                    <Youtube className="w-4 h-4" />
                    <Link
                      href="https://www.youtube.com/@surfer-kim"
                      target="_blank"
                    >
                      @surfer-kim
                    </Link>
        ...
        <div className="bg-white rounded-lg border shadow-sm">
          <div className="p-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              across the full Software Development Life Cycle (SDLC), with a consistent focus on excellence, scalability,
              and user experience.
            </p>
          </div>
        </div>
